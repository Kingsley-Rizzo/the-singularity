...
// assets/config/balance.json
{
  ...
  "structures": {
    "server_farm": { "hp": 100, "cost": 100, "upkeep_energy": 10, "agi_per_tick": 0.5 },
...
- **Knobs**: `tick_ms`, per‑entity hp/cost/upkeep, turret range/fire rate/damage, wave interval, scaling multipliers, `passive_money_per_tick`
- **Expectations** (MVP):

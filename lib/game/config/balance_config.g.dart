...
EconomyConfig _$EconomyConfigFromJson(Map<String, dynamic> json) =>
    EconomyConfig(
      ...
      baseEnergyBudget: (json['base_energy_budget'] as num).toInt(),
...
Map<String, dynamic> _$EconomyConfigToJson(EconomyConfig instance) =>
    <String, dynamic>{
      ...
      'base_energy_budget': instance.baseEnergyBudget,
...
StructureConfig _$StructureConfigFromJson(Map<String, dynamic> json) =>
    StructureConfig(
      ...
      energyReserve: (json['energy_reserve'] as num).toInt(),
      energyBudgetIncrease: (json['energy_budget_increase'] as num).toInt(),
...
Map<String, dynamic> _$StructureConfigToJson(StructureConfig instance) =>
    <String, dynamic>{
      'hp': instance.hp,
      'cost': instance.cost,
      'energy_reserve': instance.energyReserve,
      'energy_budget_increase': instance.energyBudgetIncrease,
